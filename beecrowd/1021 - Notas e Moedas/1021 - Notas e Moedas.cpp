...
/*
  ...
  */
  ...
  std::cout << billCem << " Valor: " << value << " nota (s) de R$ 50.00 " << std::endl;
  std::cout << billCem << " Valor: " << value << " nota (s) de R$ 20.00 " << std::endl;
  std::cout << billCem << " Valor: " << value << " nota (s) de R$ 10.00 " << std::endl;
  std::cout << billCem << " Valor: " << value << " nota (s) de R$ 5.00 " << std::endl;
  std::cout << billCem << " Valor: " << value << " nota (s) de R$ 2.00 " << std::endl;
